// Web Audio API synthesizers - no external audio files required!
...
class SoundEffects {
  ...
  playCoinFlip() {
    ...
    try {
      ...
      const now = this.ctx.currentTime;
      // Sequence of rapid metallic clicks mimicking a spinning coin
      const pings = [1200, 1500, 1800, 1400, 1700, 2000, 2400];
